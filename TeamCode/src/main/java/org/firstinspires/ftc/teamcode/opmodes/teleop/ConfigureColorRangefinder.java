...
public class ConfigureColorRangefinder extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        waitForStart();
        crf.setLedBrightness(15);
        crf.setPin0Digital(ColorRangefinder.DigitalMode.HSV, 160.0 / 360.0 * 255, 200.0 / 360.0 * 255); // purple
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 100);
        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 120.0 / 360.0 * 255, 140.0 / 360.0 * 255); // green
